...
public class Heater extends SmartHomeCS {
    ...
    public Heater(String name, String configFile) {
        ...
        controlDegree = Integer.parseInt(FileManager.getValueFromConfigDictionary(super.config, "heater_control_degree"));
    ...
    private void sophisticatedControl(ArrayList<Double> environment, Double monitored, Double threshold){
        int controlNum = (int)((threshold - monitored) / (temperatureControlPower/controlDegree)) + 1;
