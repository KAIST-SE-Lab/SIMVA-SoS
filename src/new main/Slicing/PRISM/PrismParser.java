        ...
        public static void main(String[] args)
        {
                ...
                try {
                        ...
                        if (args[0].equals("-modulesfile") || args[0].equals("-mf")) {
                                ...
                                mf.tidyUp();					
                                System.out.print("\u005cnAnd after expansion:\u005cn====================\u005cn\u005cn" +mf.toString());
                        }
							...
							ArrayList<String> slicingCrit = mf.getSlicedVars();
							for(int i = 2; i < args.length; i++) {
								slicingCrit.add(args[i]);
							}
							mf.setSlicedVars(slicingCrit);
							mf.testSlicing(0);
							mf.slicingTidyUp();
							//System.out.print("\u005cnAnd after expansion:\u005cn====================\u005cn\u005cn" +mf.toString(slicingCrit));
							System.out.print(mf.toString(slicingCrit));
							...
							for(int i = 2; i < args.length; i++) {
								updateList.add(args[i]);
							}
							mf.setUpdateVars(updateList);
							mf.updateModel();
//							mf.updateTidyUp();
							//System.out.print("\u005cnAnd after expansion:\u005cn====================\u005cn\u005cn" +mf.toString());
